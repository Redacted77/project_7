...
from UI import edit_user_helper_screen
if TYPE_CHECKING:
...
class EditUser(Screen):
    ...
    def on_data_table_row_selected(self, event: DataTable.RowSelected):
        ...
        self.app.push_screen(edit_user_helper_screen.EditUserInfo(self.user_info, target_user_id=user_id))
    ...
    def data_found(self, users):
        ...
        self.message("Select user to edit")
